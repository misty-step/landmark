...
Optional product rationale, not a roadmap or required reading step.
The [README](README.md), accepted [ADRs](docs/adr/), and versioned
[schemas](schemas/) define current behavior and technical contracts.

## Product aim

Landmark automatically combines commits, diffs, and product context into
coherent natural-language changelogs and release notes: what bugs were fixed,
what features were introduced, what changed, and why users should care.
LLM synthesis and automated versioning are core to the product.

A zero-secret local preview makes release decisions and artifacts inspectable.
It complements the model-assisted release journey rather than replacing it.
Configuration supplies product context, audience, voice, and destinations.
...
their native authority; work trackers may link them, not replace them.
