...
4. Replace static `LANDFALL_NOTES_EOF` output writing with collision-safe output serialization.
...
- Evidence: `action.yml:560-562` uses a static `LANDFALL_NOTES_EOF` delimiter for generated content.
