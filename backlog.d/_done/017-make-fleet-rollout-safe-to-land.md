...
6. Keep `skills/landmark-dogfood` updated with the operational workflow.
...
- Why: Landmark's value accrues when many repos adopt it safely, not when one repo has a good demo.
...
- Updated README, fleet plan schema, dogfood report, and `skills/landmark-dogfood`.
- Evidence: `cargo run --locked -p landmark -- replay-action --scenario fleet_adoption_planner --evidence-dir .landmark/replay-017-fleet` passed with 14 fixture repositories.
