...
- [ ] `fleet open-prs` for semantic-release repos either replaces the existing release job with Landmark full mode or emits a blocked plan requiring explicit operator choice.
