...
7. Separate active applications from config, docs, archives, scratch, and already-adopted repos. Do not treat every active repo as an app.
...
10. Record friction immediately. Use [references/finding-taxonomy.md](references/finding-taxonomy.md) for categories and severity.
11. Fix Landfall itself when the product made the dogfood run unsafe, confusing, or wrong. Add replay coverage for each fixed failure mode.
