...
mod release_transaction_scenarios;
mod support;
...
pub(crate) use release_transaction_scenarios::*;
...
pub(crate) fn scenario_map() -> BTreeMap<String, Scenario> {
    ...
    map.insert(
        "protected_release_pr_path".to_string(),
        scenario_protected_release_pr_path,
    );
    map.insert(
    ...
    map.insert(
        "release_transaction_prepare_and_bind".to_string(),
